...
echo.
wmic /namespace:\\root\default path systemrestore call createrestorepoint "DerpFestOS", 100, 12 >nul 2>&1
...
echo What is your System Type:
    call :MsgBox "Are you a Desktop user?"  "VBYesNo+VBQuestion" "DerpFestOS"
    if errorlevel 7 (
        echo goto:LaptopPC 
...
:smol
if not exist "%USERPROFILE%\Desktop\DerpFestOSOptionalTweaks" mkdir %USERPROFILE%\Desktop\DerpFestOSOptionalTweaks
explorer.exe %USERPROFILE%\Desktop\DerpFestOSOptionalTweaks
...
echo.
SET msgboxTitle=DerpFestOS
SET msgboxBody=DerpFestOS Tweaks Have been Applied, Please Restart your PC <3
